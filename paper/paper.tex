...
\begin{figure}[H]
\includegraphics[width=0.75\columnwidth]{paper/figures/results/target_correlations.pdf}
\caption{\label{fig:target-correlations}}
\end{figure}   

\begin{figure}[H]
\includegraphics[width=0.75\columnwidth]{paper/figures/results/downwelling-hist.pdf}
...
- Data Distribution (unimodal, multimodal, spatial variability within each day)
- Fit results (parameter regions where performance is poor)
- Feature importance rankings 
- Maps
- Can we explain the quality of fit? e.g. target is optically active, correlates with an optically active substance, or has some other physical explanation
...
%\begin{adjustwidth}{-\extralength}{0cm}
\centering
%\includegraphics[width=16.0cm]{paper/figures/results/fits/biochemical-fitres.png}
\includegraphics[width=\columnwidth]{paper/figures/results/fits/biochemical-fitres.pdf}
%\end{adjustwidth}
...
\begin{adjustwidth}{-\extralength}{0cm}
\centering
\includegraphics[width=18.0cm]{paper/figures/results/fits/biochemical-ranking.pdf}
\end{adjustwidth}
\caption{Ranked feature importances for the same three chemical concentration models.\label{fig:biochem-fi}}
\end{figure}  
...
\end{adjustwidth}
\caption{Ranked feature importances for the same three chemical concentration models.\label{fig:chemicals-fi}}
\end{figure}  
...
\end{adjustwidth}
\caption{Ranked feature importances for the same three physical parameter models.\label{fig:physical-fi}}
\end{figure}  
...
\end{adjustwidth}
\caption{Ranked feature importances for the same three ion concentration models.\label{fig:ions-fi}}
\end{figure}  
