...
% \cite{cohen2004landsat, melesse2007remote, allison2016airborne, joyce2009review, robert2017analysis}
...
\begin{table}[H] 
\caption{Hyperparameter values for the final models.\label{tab5}}
\newcolumntype{C}{>{\centering\arraybackslash}X}
\begin{tabularx}{\textwidth}{CCCCCCC}
\toprule
\textbf{Target}	& \textbf{Number of Trees}	& \textbf{Sampling Ratio} & \textbf{Maximum tree depth} & \textbf{Number of Subfeatures} & \textbf{Minimum samples per leaf} & \textbf{Minimum samples per split}\\
\midrule
