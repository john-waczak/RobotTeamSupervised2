...
For example, Garcia -Ruiz et al. (2013) conducted a UAV-based 56 aerial survey with multispectral cameras over a citrus orchard, and found that 57 UAV-based datasets yielded better classification accuracy than aircraft-based 58 datasets for diseased citrus trees. Moreover, Peña et al. (2013, 2015) applied 59 UAV-based multispectral imaging for the early detection of weed seedlings in 60 combination with object-based image analysis.
