...
\Author{\hl{John} %MDPI: Please carefully check the accuracy of names and affiliations.
 Waczak \orcidA{}, Adam Aker, Lakitha O. H. Wijeratne, Shawhin Talebi, Bharana Fernando, \hl{Prabuddha Hathurusinghe}%MDPI: The name of this author is different from the one submitted online at susy.mdpi.com. Please confirm which one is correct.
, Mazhar Iqbal, Matthew Lary, David Schaefer and David J. Lary *\orcidB{}}
...
\address[1]{%
Hanson Center for Space Sciences, University of Texas at Dallas, Richardson, TX 75080, USA;  \hl{john.waczak@utdallas.edu} %MDPI: We changed all emails into lowercase. Please confirm.
 (J.W.); adam.aker@utdallas.edu (A.A.); lhw150030@utdallas.edu (L.O.H.W.); shawhintalebi@gmail.com (S.T.); ashen.fernando@utdallas.edu  (B.F.); prabuddhamadusanka.hathurusinghedewage@utdallas.edu (P.H.); mazhar.iqbal@utdallas.edu (M.I.); \hl{mdlary@me.com} %MDPI: This email address is different from the one submitted online at susy.mdpi.com. Please confirm which one is correct.
 (M.L.); captdaveschaefer@gmail.com (D.S.)}
...
To effectively utilize the spectra collected by our UAV, we must account for the variability of the incident light that illuminates the water and transform the raw hyperspectral data cubes from their native \textit{\hl{imaging~reference~frame}} %MDPI: Please confirm if the italics is unnecessary and can be removed. The following highlights are the same.
...
%\end{adjustwidth}
\vspace{-0.4in}
\caption{\hl{Hyperspectral} %MDPI: Please add the explanation for different color in the figure.
...
The robot team was deployed at a private pond in Montague, Texas, close to the Oklahoma border for three separate collections on \hl{23} %MDPI: We changed all date format in main tex. Please confirm.
