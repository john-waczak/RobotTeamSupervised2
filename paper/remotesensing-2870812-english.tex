...
\vspace{-0.15in}
\hspace{-6pt}\includegraphics[width=\columnwidth]{figures/results/fits/biochemical-fitres.pdf}
\vspace{-0.1in}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% optional
\supplementary{The following supporting information can be downloaded at:  \linksupplementary{s1}, Table S1: %MDPI: please provide an independent file to indicate supplementary materials.
...
\newblock In {\em Unmanned Aerial Vehicle: Applications in Agriculture and
  Environment}; Springer International Publishing: Cham, Switzerland, 2020 %MDPI: Please add the name of the publisher and their location.
; pp. 25--38.
...
\newblock Technical report; US Geological Survey: Reston, VA, United States, %MDPI: Please add the location of the publisher (City and Country).
  2017.
...
\newblock In {\em International Archives of Photogrammetry Remote Sensing and 
  Spatial Information Sciences}; {2002}; pp. 148--153. %MDPI: Please add the name of the publisher and their location.
...
\newblock {\em Hyperspectral Indices and Image Classifications for Agriculture
  and Vegetation}; CRC Press:  Boca Raton, FL, USA,
 2018.
...
Breiman, L.
\newblock {\em Classification and Regression Trees}; CRC Press: Boca Raton, FL, USA,  %MDPI: Please add the location of the publisher (City and Country).
  2017.
...
\newblock Inductive conformal prediction: Theory and application to neural
  networks. In {\em Tools in Artificial Intelligence}; IntechOpen: London, United Kingdom %MDPI: Please add the location of the publisher (City and Country).
 2008.
